...
if __name__ == "__main__":
    ...
    rospy.init_node('findenemy_sub', anonymous=False)
    ...
    pub = rospy.Publisher('pub_enemy_position', enemyAndFriends, queue_size=10)
    ...
    # Ex:
    ts = message_filters.TimeSynchronizer([message_filters.Subscriber('findenemy_pub1', eposesM),
                                            message_filters.Subscriber('findenemy_pub2', eposesM),
                                            message_filters.Subscriber('findenemy_pub3', eposesM),
                                            message_filters.Subscriber('findenemy_pub4', eposesM),
                                            message_filters.Subscriber('findenemy_pub5', eposesM),
                                            message_filters.Subscriber('findenemy_pub6', eposesM)], 10)
    ts.registerCallback(callback)
